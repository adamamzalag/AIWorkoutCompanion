...
import WorkoutCompletedPage from "@/pages/workout-completed";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/workout-completed" component={WorkoutCompletedPage} />
...
function App() {
  ...
  const isWorkoutPage = location === '/workout' || location === '/workout-new' || location === '/workout-completed';
